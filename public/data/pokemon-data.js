...
const REGIONAL_VARIANTS = [
  ...
  { speciesId: 105, form: "alola", regionCode: "A", name: "Marowak (Alolan)", formSlug: "marowak-alola" },
  ...
  { speciesId: 122, form: "galar", regionCode: "G", name: "Mr. Mime (Galarian)", formSlug: "mr-mime-galar" },
  {
    ...
    pokemonId: 10250,
    sprite: `${SPRITE_BASE_URL}/10250.png`,
  },
  {
    speciesId: 128,
    form: "paldea-blaze",
    ...
    pokemonId: 10251,
    sprite: `${SPRITE_BASE_URL}/10251.png`,
  },
  {
    speciesId: 128,
    form: "paldea-aqua",
    ...
    pokemonId: 10252,
    sprite: `${SPRITE_BASE_URL}/10252.png`,
  },
...
const MEGA_FORMS = [
  ...
  //legendsza vanaf hier
  { speciesId: 36, form: "mega", regionCode: "M", name: "Clefable (Mega)", formSlug: "clefable-mega", pokemonSlug: "clefable-mega" },
  { speciesId: 71, form: "mega", regionCode: "M", name: "Victreebel (Mega)", formSlug: "victreebel-mega", pokemonSlug: "victreebel-mega" },
  { speciesId: 121, form: "mega", regionCode: "M", name: "Starmie (Mega)", formSlug: "starmie-mega", pokemonSlug: "starmie-mega" },
  { speciesId: 149, form: "mega", regionCode: "M", name: "Dragonite (Mega)", formSlug: "dragonite-mega", pokemonSlug: "dragonite-mega" },
  { speciesId: 154, form: "mega", regionCode: "M", name: "Meganium (Mega)", formSlug: "meganium-mega", pokemonSlug: "meganium-mega" },
  { speciesId: 160, form: "mega", regionCode: "M", name: "Feraligatr (Mega)", formSlug: "feraligatr-mega", pokemonSlug: "feraligatr-mega" },
  { speciesId: 227, form: "mega", regionCode: "M", name: "Skarmory (Mega)", formSlug: "skarmory-mega", pokemonSlug: "skarmory-mega" },
  { speciesId: 478, form: "mega", regionCode: "M", name: "Froslass (Mega)", formSlug: "froslass-mega", pokemonSlug: "froslass-mega" },
  { speciesId: 500, form: "mega", regionCode: "M", name: "Emboar (Mega)", formSlug: "emboar-mega", pokemonSlug: "emboar-mega" },
  { speciesId: 530, form: "mega", regionCode: "M", name: "Excadrill (Mega)", formSlug: "excadrill-mega", pokemonSlug: "excadrill-mega" },
  { speciesId: 545, form: "mega", regionCode: "M", name: "Scolipede (Mega)", formSlug: "scolipede-mega", pokemonSlug: "scolipede-mega" },
  { speciesId: 560, form: "mega", regionCode: "M", name: "Scrafty (Mega)", formSlug: "scrafty-mega", pokemonSlug: "scrafty-mega" },
  { speciesId: 604, form: "mega", regionCode: "M", name: "Eelektross (Mega)", formSlug: "eelektross-mega", pokemonSlug: "eelektross-mega" },
  { speciesId: 609, form: "mega", regionCode: "M", name: "Chandelure (Mega)", formSlug: "chandelure-mega", pokemonSlug: "chandelure-mega" },
  { speciesId: 652, form: "mega", regionCode: "M", name: "Chesnaught (Mega)", formSlug: "chesnaught-mega", pokemonSlug: "chesnaught-mega" },
  { speciesId: 655, form: "mega", regionCode: "M", name: "Delphox (Mega)", formSlug: "delphox-mega", pokemonSlug: "delphox-mega" },
  { speciesId: 658, form: "mega", regionCode: "M", name: "Greninja (Mega)", formSlug: "greninja-mega", pokemonSlug: "greninja-mega" },
  { speciesId: 668, form: "mega", regionCode: "M", name: "Pyroar (Mega)", formSlug: "pyroar-mega", pokemonSlug: "pyroar-mega" },
  { speciesId: 670, form: "mega", regionCode: "M", name: "Floette (Mega)", formSlug: "floette-mega", pokemonSlug: "floette-mega" },
  { speciesId: 687, form: "mega", regionCode: "M", name: "Malamar (Mega)", formSlug: "malamar-mega", pokemonSlug: "malamar-mega" },
  { speciesId: 689, form: "mega", regionCode: "M", name: "Barbaracle (Mega)", formSlug: "barbaracle-mega", pokemonSlug: "barbaracle-mega" },
  { speciesId: 693, form: "mega", regionCode: "M", name: "Dragalge (Mega)", formSlug: "dragalge-mega", pokemonSlug: "dragalge-mega" },
  { speciesId: 701, form: "mega", regionCode: "M", name: "Hawlucha (Mega)", formSlug: "hawlucha-mega", pokemonSlug: "hawlucha-mega" },
  { speciesId: 718, form: "mega", regionCode: "M", name: "Zygarde (Mega)", formSlug: "zygarde-mega", pokemonSlug: "zygarde-mega" },
  { speciesId: 780, form: "mega", regionCode: "M", name: "Drampa (Mega)", formSlug: "drampa-mega", pokemonSlug: "drampa-mega" },
  { speciesId: 870, form: "mega", regionCode: "M", name: "Falinks (Mega)", formSlug: "falinks-mega", pokemonSlug: "falinks-mega" },
];
...
const SPECIAL_FORM_CACHE_VERSION = 1;
...
function registerCachedSpecialForms(cacheEntries, slugLookup) {
  ...
  cacheEntries.forEach((entry) => {
    ...
    const species = slugLookup.get(entry.speciesSlug);
    if (!species) return;
    registerVariant({
...
async function processSpecialFormEntry(entry, options) {
  ...
  try {
    ...
    const species = slugLookup.get(speciesSlug);
    if (!species) {
      return;
    }
    ...
    registerVariant({
      speciesId: species.id,
      form: formIdentifier,
      name: formLabel ? `${species.name} (${formLabel})` : species.name,
      formSlug: entry.name,
        ...
        source: {
          ...
          speciesOverrides: {
            128: {
              ...
              pokemonId: 10250,
              pokemonSlug: "tauros-paldea-combat-breed",
              spriteOverride: `${SPRITE_BASE_URL}/10250.png`,
            },
            194: { form: "paldea" },
          },
        },
...
async function getPokemonDetails(entry) {
  ...
  if (pokemonData.sprites?.versions) {
    Object.values(pokemonData.sprites.versions).forEach((group) => {
      if (!group) return;
      Object.entries(group).forEach(([versionName, spriteSet]) => {
        if (!versionName || !spriteSet) return;
        const target = versionSprites[versionName] || {};
        if (spriteSet.front_default && !target.front_default) {
          target.front_default = spriteSet.front_default;
        }
        if (spriteSet.front_female && !target.front_female) {
          target.front_female = spriteSet.front_female;
        }
        if (spriteSet.front_shiny && !target.front_shiny) {
          target.front_shiny = spriteSet.front_shiny;
        }
        if (spriteSet.front_shiny_female && !target.front_shiny_female) {
          target.front_shiny_female = spriteSet.front_shiny_female;
        }
        if (spriteSet.animated?.front_default && !target.animated) {
          target.animated = spriteSet.animated.front_default;
        }
        versionSprites[versionName] = target;
      });
    });
  }
  const sprites = {
