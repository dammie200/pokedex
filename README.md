...
- Bekijk per kaart de typen van de Pokémon dankzij compacte typebadges.
- Klik op de naam van een Pokémon voor een gedetailleerd overzicht met types, 3D-sprite, vanglocaties, evoluties en in welke spellen de soort beschikbaar is.
